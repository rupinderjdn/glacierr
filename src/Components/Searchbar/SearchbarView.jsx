...
const SearchbarView = props => {
  return (
    <div className=' flex flex-row items-center p-2 m-2 shadow-3xl bg-platform-2 rounded-lg text-gray-400'>
      ...
      <input className='px-4 flex-1 focus:border-none outline-none focus:border-transparent ml-4  bg-inherit border-none select-none' placeholder='Search for cities' />
    </div>
  )
}
